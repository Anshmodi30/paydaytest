...
function Step2() {
  ...
  async function handlesubmit(e) {
    if (
      ...
      Fname.current.value != "" &&
      Appartment.current.value != "" &&
      PostalCode.current.value != "" &&
      Lname.current.value != "" &&
      City.current.value != "" &&
      Email.current.value != "" &&
      YearsAtAddress.current.value != "" &&
      MonthsAtAddress.current.value != "" &&
      CellPhone.current.value != "" &&
      Sin.current.value != "" &&
      ...
      const response = await fetch(
        process.env.REACT_APP_SERVER + "/loanAmount",
        {
          method: "POST",
    ...
    <>
      <div className=" w-full  items-center px-5 md:px-10  lg:px-44 py-5 md:py-10 lg:py-24   flex flex-col justify-center  gap-7 bg-onhov ">
        <div className=" bg-white rounded-2xl border-[1px] flex flex-col justify-center   border-[#bababa] shadow-xl w-full p-7">
          <p className=" font-Montserrat text-[16px] md:text-[20px] text-[#808080]">
            Receive an instant decision in approximately{" "}
            <span className=" text-primary">4 minutes</span>.
          </p>
        ...
        <div className=" w-full  flex flex-col md:flex-row  justify-between items-center">
          <div className=" bg-white rounded-2xl border-[1px] flex flex-col justify-center items-start gap-5 border-[#bababa] shadow-xl w-full px-8 py-5">
            ...
            <div className="  w-full flex flex-col  justify-between  font-Montserrat  items-center gap-6 ">
              <div className=" w-full px-3 md:px-3  md:gap-0 gap-5 lg:px-16 flex flex-col md:flex-row  justify-between items-center">
                <div className=" text-seconday">
                  <Select
                    className="  w-[270px] md:w-[280px]  lg:w-[290px] "
                    styles={{
                      input: {
                        background: "#ffffff81",
                        padding: "4px",
            ...
            <div className=" px-5 md:px-16 w-full flex flex-row py-3  justify-start items-start gap-3">
              ...
              <p className=" relative  -top-1">
                By checking the box and clicking "Submit", you consent to
                GoDay's collection, use and disclosure of your personal
              ...
              <button
                ...
                className={
                  !checked
                    ? "hidden"
                    : "" +
                      `  text-[16px] md:text-[18px] font-medium w-[100px] md:w-[120px] text-white  font-Montserrat py-1 md:py-1  rounded-full bg-gradient-to-r  border-[2px] border-transparent transition-all duration-300 from-gradfrom to-gradto hover:from-white  hover:tp-white hover:border-[2px] hover:border-primary  hover:text-primary`
                }
              >
                Next
              </button>
              <button
                className={
                  checked
                    ? "hidden"
                    : "" +
                      ` text-[16px] md:text-[18px] font-medium w-[100px] md:w-[120px] text-white  font-Montserrat py-1 md:py-1  rounded-full bg-gradient-to-r  border-[2px] border-transparent transition-all duration-300 from-[#c7c7c7] to-[#c7c7c7]    `
                }
              >
                Next
              </button>
          ...
          <div className=" md:hidden lg:block h-full md:pt-0 pt-10 self-start md:pl-6 md:w-[380px]">
            ...
            <div className=" mt-5 p-5 bg-white rounded-2xl  border-[3px] border-primary ">
              Have you taken out a GoDay Loan in the last 9 months? Click here
              to visit the Express Loan Application!
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col  rounded-xl hover:bg-[#f4f9ff] transition-all duration-300 overflow-hidden justify-between flex-1 md:p-3 p-4 lg:p-3 bg-white shadow-lg lg:py-5 lg:px-5">
        <div class="flex-1 ">
          ...
          <blockquote class="flex-1 mt-2">
            <p class="  md:text-[14px] lg:text-[14px] lg:text-lg leading-relaxed  text-ellipsis font-Montserrat text-gray-900 ">
              “You made it so simple. My new site is so much faster and easier
              to work with than my old site. I just choose the page, make the
              change.”
            </p>
          </blockquote>
          <p class=" lg:text-[16px] md:text-[14px]   font-bold font-Varela uppercase text-gray-900 font-pj">
            Leslie Alexander
          </p>
        </div>
